        ...
        <div className="fixed z-50 inset-0 flex  items-center justify-center bgBlur" onClick={() => setIsOpen(false)}>
          <div onClick={(e) => e.stopPropagation()} className="z-50 fixed h-[90%] bg-slate-800 py-6 rounded-4xl shadow-lg w-[60%] max-lg:w-[90%] h-[80%] max-lg:h-[76%] border-[1px] border-slate-500 flex flex-col space-y-2 justify-between">
            <div className="w-full flex  max-md:flex-col-reverse items-center justify-items-center text-center justify-between border-b-[1px] border-slate-500 max-md:text-xl">
                  {/* Botão para fechar */}
            <h2 className="text-orange-200 text-4xl text-left px-8 py-4 max-md:text-3xl">Sobre a Gluteoplastia</h2>
            <button
            ...
            <h2 className="font-semibold mb-2 text-blue-500 text-3xl px-8 max-md:text-2xl">O que é a Gluteoplastia?
            </h2>
            <p className="text-gray-100 px-8 py-2 text-lg max-md:text-md">A Gluteoplastia, também conhecida como implante de prótese glútea, é uma cirurgia que busca melhorar o formato e o volume da região dos glúteos. Após o procedimento, o cuidado adequado no pós-operatório é fundamental para garantir um resultado satisfatório, seguro e duradouro. Neste guia, você encontrará todas as orientações necessárias, abordando desde a postura correta para dormir até os alimentos mais recomendados para auxiliar na recuperação.
</p>

            ...
            <div className="text-white p-6 rounded-lg w-full h-full">
              ...
              <div className="bg-slate-800 space-y-8 rounded-lg">
                ...
                <div className="flex justify-between border-b border-gray-700 py-2">
                  ...
                  <span className="text-right">Redução inicial do inchaço e desconforto, com melhora gradual do contorno glúteo</span>
                </div>
                <div className="flex justify-between border-b border-gray-700 py-2">
                  <span>1-2 meses</span>
                ...
                <div className="flex justify-between py-2">
                  <span>3-6 meses</span>
                  <span className="text-right">Resultados finais com glúteos mais volumosos e definidos, cicatrizes mais suaves</span>
                </div>
              </div>
            </div>
          </div>
